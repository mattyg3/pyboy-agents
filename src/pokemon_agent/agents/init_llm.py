...
# llm_model_cv = ChatOllama(model="gemma3:4b", temperature=1.0, top_k = 64, top_p = 0.95 , validate_model_on_init=True)  #can use pydantic BaseModel for structured output
...
#     llm_model = client.llm.model("qwen/qwen3-4b-thinking-2507")

# llm_model_cv = lms.llm("qwen/qwen3-vl-8b@q4_k_m")

# llm_model_cv = lms.llm("mistralai/magistral-small-2509@q4_k_m")